...
const schema = joi.object().keys({
  ...
  username: joi.string().when('auth', { is: 'SASL', then: joi.required(), otherwise: joi.optional() }),
  password: joi.string().when('auth', { is: 'SASL', then: joi.required(), otherwise: joi.optional() }),
